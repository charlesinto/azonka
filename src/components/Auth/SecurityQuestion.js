    ...
    return keys.map((element, index) => (
      <div key={index}>
        <div>
          ...
          <span className="question-tag">{this.props.questions[element]}</span>
        </div>
        <CustomInput
  ...
  onSubmit = (event) => {
    ...
    if (this.state.question.trim() === "") {
      return this.props.renderError(
        "Please choose a question and provide answer"
      );
    }
    ...
    if (this.state.pincode.length !== 4) {
      return this.props.renderError(
        "Please provide a valid pin code with four(4) numbers"
      );
    }
    //call the api
    this.props.initiateRegistration();
              ...
              >
                <form>
                    ...
                    <div className="col-md-12">
                      <div className="form-group required-field">
                        ...
                        >
                          ...
                          {this.state.securityQuestion.map(
                            ({ id, question }, i) => {
                              return (
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group required-field">
                        <label htmlFor="acc-name">Enter PIN</label>
                        <input
...
const mapStateToProps = (state) => {
  const {
    reg: { questions, errorMessage, error },
  } = state;
  return {
    questions,
    error,
...
export default connect(
  mapStateToProps,
  actions
)(withToastManager(SecurityQuestion));
