    ...
    return (
      <>
        <div className="row item-row py-3 my-4 bg-white" key={id}>
          ...
          <div
            className="item-subtotal col-md-2 flex-column border-right text-center text-success hide-mobile "
          ...
          >
            <button
              ...
              id={id}
              onClick={(e) => this.handleAddCart(e, id)}
            >
              BUY NOW
            </button>
            <span
              className="text-danger font-13 pointer"
              onClick={(e) => {
          ...
          <div className="mobile-item-details-wrapper container">
            <div className="container-fluid border-top py-3">
              ...
              <div className="d-flex item-actions justify-content-between">
                ...
                <span
                  className="text-danger font-17 pointer d-flex align-items-center"
                  onClick={(e) => {
                    this.handleItemDelete(id);
                  }}
                >
