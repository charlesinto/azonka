...
export default (state = INITIATL_STATE, actions) => {
  switch (actions.type) {
    case SET_CATEGORIES:
      console.log("in home reducers", actions.payload);
      return { ...state, home_categories: actions.payload };
    ...
    case UPDATE_ACCOUNT:
      return {
        ...state,
        currentUser: actions.payload.userData,
        likes: actions.payload.likes,
