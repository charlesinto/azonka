        ...
        <div className="row item-row py-3 my-4 bg-white" key={id}>
          ...
          <div className=" col-md-4 border-right">
            <div className="d-flex item-name-wrapper">
              <img className="item-img" src={mainImageUrl} alt=".../" />
              <p className="pl-4 item-name text-dark"> {name}</p>
            </div>
            <div
              className="d-flex item-actions hide-mobile justify-content-between"
              style={{ fontSize: "12px" }}
            >
              ...
              {/* <div className="wishlist-wrap">
                <span
                  className="pointer"
                  id={id}
                  onClick={this.handleMoveWishList}
                >
              ...
              <div>
                ...
                >
                  ...
                  {this.props.data.products.length === 1 ? (
                    <span
                      className="text-yellow font-15"
                      data-toggle="modal"
                      data-target={`#modal${randomId}`}
                      onClick={(e) => {
                    ...
                    >
                      <i
                        className="fas fa-star px-2 text-yellow"
                        style={{ color: "#e0c325" }}
                      ></i>
                    </span>
                  ) : null}
          ...
          <div className="item-subtotal col-md-2 border-right text-center hide-mobile">
            ...
            {this.numberWithCommas(
              (finalPrice / 100) * this.props.data.quantity[id]
            )}
          </div>
            ...
            <div className="container-fluid border-top py-3">
              ...
              <div className="d-flex item-actions justify-content-between">
                <div className="wishlist-mobile-wrap">
                  <span>
                    {" "}
                    <i className="fas fa-shopping-bag px-2"></i> Move to
                    wishlist
                  </span>
                </div>
                <div>
