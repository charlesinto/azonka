            ...
            <div class="modal-content">
              <div class="modal-header">
                <div className="d-flex">
                  <h5 class="modal-title mx-4" id="exampleModalLongTitle">
                    ORDER: <span>#{this.props.order}</span>
                  </h5>
                  <button
                    onClick={() => this.rejectItem()}
                    className="btn-cm btn-danger mx-4"
                  >
                    Reject Item
                  </button>
                </div>
                ...
                {this.props.orderData
                  ? this.props.orderData.map((o) => {
                      ...
                      return (
                        <>
                          <div
                            className="row item-row py-3 my-4 mb-3 bg-white px-4"
                            key={id}
                          >
                            <div className=" col-md-5 border-right">
                              <div className="d-flex item-name-wrapper">
                                <input
                                  onChange={() => this.handleItemCheck(o)}
                                  style={{ display: "block" }}
                                  className="mx-2"
                                  type="checkbox"
                              ...
                              <div className="container-fluid border-top py-3">
                                ...
                                <div className="d-flex my-5 justify-content-end">
                                  ...
                                  <span className="mobile-item-subtotal text-primary">
                                    {" "}
                                    ₦{" "}
                                    {finalPrice * this.props.data.quantity[id]}
                                  </span>
                                </div>
