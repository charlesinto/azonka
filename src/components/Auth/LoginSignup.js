...
class LoginSignup extends Component {
  ...
  handleFormSubmit = (e, form) => {
    e.preventDefault();
    if (form === "login") {
      const validationResponse = this.validateFormData(
        this.state.login,
        "login"
      );
      ...
      if (!isValid) {
        ...
        this.props.renderError(
          "Incomplete Details, please check and try again"
        );
      ...
      if (!isValid) {
        const { inValidElments, validationMessage } = validationResponse;
        this.props.renderError(
          "Incorrect data provided, Please check and try again"
        );
    ...
    if (form === "login") {
      ...
      if (!(emailAddress.trim() !== "" && Validator.isEmail(emailAddress))) {
        ...
        validationMessage["emailAddress"] =
          "Email is required or not in right format";
      }
      if (!(password.trim() !== "")) {
        isValid = false;
      ...
      if (
        ...
        validationMessage["emailAddress"] =
          "Email required or not in right format";
      }
      if (country.trim() === "") {
        isValid = false;
      ...
      if (!(repeatPassword === password)) {
        ...
        validationMessage["repeatPassword"] =
          "Repeat Password and Password do not match";
      }
      ...
      if (extendedUserType.trim() !== "") {
        if (extendedUserType.trim() === "seller") {
          if (!(headOfficeAddress.trim() !== "")) {
            ...
            validationMessage["headOfficeAddress"] =
  ...
  render() {
    ...
    return (
      <div>
        {/* <Header /> */}
        <div
          className="router-container mfp-content"
          style={{
            display: "block",
            zIndex: 1,
          }}
        >
          <div
            ...
            style={{ padding: "2rem 0 2rem 0rem" }}
          >
            <div className="container">
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <form action="#" className="mb-1">
                      ...
                      <input
                        name="emailAddress"
                        value={this.state.login.emailAddress}
                        ...
                        required=""
                      />
                      {this.state.login.inValidElments.includes(
                        "emailAddress"
                      ) ? (
                  ...
                  <div
                    className="col-md-6"
                    style={{ borderLeft: "1px solid #f3f3f3" }}
                  >
              ...
              <div className="mobile-form">
                ...
                >
                  <Tabs
                    ...
                    onChange={(value, newValue) =>
                      this.handleChange(newValue, "tab", value)
                    }
                ...
                <TabPanel value={this.state.tab} index="signup">
                  <form action="#">
                    <label htmlFor="register-firstname5">
                    ...
                    <input
                      ...
                      type="text"
                      className="form-input form-wide mb-2"
                      id="register-firstname5"
                      required=""
                    />
                    {this.state.register.inValidElments.includes(
                      "firstName"
                    ) ? (
                      <div className="error-message required">
                    ...
                    <label htmlFor="register-lastname5">
                    ...
                    <select
                      name="gender"
                      value={this.state.register.gender}
                      onChange={(e) => this.handleInputChange(e, "register")}
                      className="mb-2"
                      id="gender"
                    >
                    ...
                    <label htmlFor="register-country5">
                    ...
                    >
                      ...
                      {this.state.countryData.map((data, i) => {
                        ...
                        return (
                          <option key={i} value={data.callingCodes[0]}>
                            {data.name}
                          </option>
                        );
                      })}
                    ...
                    <label htmlFor="register-phonenumber5">
                    ...
                    <label htmlFor="register-email5">
                      Email address <span className="required">*</span>
                    </label>
                    <input
                      name="emailAddress"
                      value={this.state.register.emailAddress}
                      onChange={(e) => this.handleInputChange(e, "register")}
                      type="email"
                      className="form-input form-wide mb-2"
                      id="register-email5"
                    ...
                    <label htmlFor="register-password5">
                      Password <span className="required">*</span>
                    </label>
                    <input
                      name="password"
                    ...
                    <label htmlFor="register-repeatpassword5">
                    ...
                    {this.state.register.inValidElments.includes(
                      ...
                      <div className="error-message required">
                        {
                          this.state.register.validationMessage[
                            "repeatPassword"
                          ]
                        }
                      </div>
                    ) : null}
                    <label htmlFor="register-code5">
                      Referral Code (optional){" "}
                      <span
                        onClick={this.openWhatIsThisModal}
                        className="cursor-pointer ml-2 text-underline text-primary"
                      >
                        What is this?
                      </span>
                    </label>
                    <input
                      name="referredBy"
                      value={this.state.register.referredBy}
                      onChange={(e) => this.handleInputChange(e, "register")}
                      type="text"
                      className="form-input form-wide mb-2"
                      id="register-code5"
                    ...
                    >
                      ...
                      <div className="custom-control custom-checkbox">
                        <input
                          ...
                          id="newsletter-signup1"
                        />
                        <label
                          className="custom-control-label"
                          for="newsletter-signup1"
                        >
                          <a href="#n">I agree to Terms and Policy</a>
                        </label>
                      </div>
                    </div>
                  </form>
              ...
              <div className="modal-body">
                <form>
                  <div className="form-group">
                    ...
                    <input
                      type="email"
                      value={this.state.resetAccount.emailAddress}
                      onChange={(e) =>
                        this.handleInputChange(e, "resetAccount")
                      }
                      name="emailAddress"
        ...
        <div
          ...
          id="whatIsThisModal"
          tabindex="-1"
          aria-labelledby="whatIsThisModal"
          aria-hidden="true"
        >
