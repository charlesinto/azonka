...
class confirmAccount extends Component {
    ...
    this.setState(
      {
        emailAddress: JSON.parse(localStorage.getItem("userRegDetails"))
          ? JSON.parse(localStorage.getItem("userRegDetails")).emailAddress
          : "",
        password: JSON.parse(localStorage.getItem("userRegDetails"))
          ? JSON.parse(localStorage.getItem("userRegDetails")).password
          : "",
      },
      () => {
        if (
  ...
  resendEmailPasscode = (e) => {
    ...
    this.props.showSuccessALert(
      "Successful, Please check your mail to continue"
    );
  };
  handleOnclick = (e) => {
    e.preventDefault();
    ...
    if (this.props.verification === "none") {
      return (
        ...
        >
          ...
          >
            <span
              style={{ marginRight: 16, color: "#08c", marginTop: "0.4rem" }}
            >
          ...
          >
            <Link
              to="/"
              style={{ color: "#fff" }}
              className="web-font btn btn-warning"
            >
              CONTINUE TO HOME
            </Link>
          </div>
      ...
      return (
        <div
          className="col-md-4 card"
          style={{ padding: "20px 10px 20px 10px", margin: "10px" }}
        >
          <div
            className="web-font"
            style={{ display: "flex", flexDirection: "row" }}
          ...
          <div
            className="web-font"
            style={{ textAlign: "right", margin: "10px 20px 20px 0px" }}
          >
            <button
