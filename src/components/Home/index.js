...
class Home extends Component {
  ...
  getFeaturedCategoriesImages = async () => {
    ...
    const ads = responseAds.data.ads.filter(
      (item) => item.page === Pages.HOME_PAGE
    );
    console.log("ads", ads);
                      ...
                      <div className="widget-posts-slider owl-carousel owl-theme">
                        <div className="post">
                          ...
                          <h4 className="post-title">
                            <a href="#n">Fashion News</a>
                          </h4>
                          <p>
                            Lorem ipsum dolor sit amet, consectetur elitad
                            adipiscing Cras non placerat mi.{" "}
                          </p>
                        </div>
                        ...
                        <div className="post">
                          ...
                          <h4 className="post-title">
                            <a href="#n">Shopping News</a>
                          </h4>
                          <p>
                            Lorem ipsum dolor sit amet, consectetur elitad
                            adipiscing Cras non plasasyi.{" "}
                          </p>
                        </div>
                ...
                <div className="col-md-8 col-lg-8">
                  <div className="row d-flex justify-content-center">
                    <div className="col-lg-10">
                      <div className="bnk">
                        {/*owl-carousel owl-carousel-lazy owl-theme owl-theme-light* */}
                        <div
                            ...
                            {this.state.topBanner.length > 0
                              ? this.state.topBanner.map((item, i) => {
                                  return (
                                    <div
                                      key={i}
                                      className={`carousel-item banners-containers ${
                                        i === 0 ? "active" : ""
                                      }`}
                                    >
                                      <img
                          ...
                          return (
                            <div className="col-lg-3  col-sm-3">
                              <div className="banner bg-white banner-image added-services">
                                ...
                                <div className="text">Azonka credits</div>
                              </div>
                            </div>
                          );
                        })}
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="feature-box feature-box-simple text-center">
                        ...
                        <div className="feature-box-content">
                          ...
                          <a href="#n" className="btn btn-outline-dark">
                            Get in touch
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="col-sm-6 col-md-6">
                      <div className="feature-box feature-box-simple text-center">
                        ...
                        <div className="feature-box-content">
                          <h3>Free Returns</h3>
                          <p>
                            We stand behind our goods and services and want you
