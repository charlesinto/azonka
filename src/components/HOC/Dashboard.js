                  ...
                  <div className="widget widget-dashboard">
                    <ul className="list">
                      <li
                        ...
                        className={
                          this.props.dashboardActiveLink === "Profile"
                            ? "active"
                            : ""
                        }
                      >
                        ...
                        {userData && !userData.pinSet ? (
                          <span
                            onClick={this.redirectToSetupWallet}
                            className="setup-wallet badge badge-info"
                          >
                            Setup wallet
                          </span>
                        ) : null}
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "Cart"
                            ? "active"
                            : ""
                        }
                      >
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "My Orders"
                            ? "active"
                            : ""
                        }
                      >
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "Change Password"
                            ? "active"
                            : ""
                        }
                      >
                        <Link to="/users/reset-password">Change Password</Link>
                      </li>
                      <li
                        className={
                          this.props.dashboardActiveLink === "Change Pincode"
                            ? "active"
                            : ""
                        }
                      >
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "Bank"
                            ? "active"
                            : ""
                        }
                      >
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "Azonka Wallet" ||
                          this.props.dashboardActiveLink ===
                            "Wallet Withdrawal" ||
                          this.props.dashboardActiveLink === "Wallet Transfer"
                            ? "activeParent"
                            : ""
                        }
                      >
                      ...
                      <li
                        className={
                          this.props.dashboardActiveLink === "My Azonka Credits"
                            ? "active"
                            : ""
                        }
                      >
                        <Link to="/users/azonka-credits">My Azonka Credit</Link>
                      </li>
                      {/* <li className={this.props.dashboardActiveLink === 'Azonka Pay' ? 'active' : ''}><Link to="#">Azonka Pay</Link></li> */}
                      <li
                        className={
                          this.props.dashboardActiveLink === "My Address Book"
                            ? "active"
                            : ""
                        }
                      >
                        <Link to="/users/address">Address Book</Link>
                      </li>
                      <li
                        className={
                          this.props.dashboardActiveLink === "Referral"
                            ? "active"
                            : ""
                        }
                      >
                        <Link to="/users/referrals">Referral</Link>
                      </li>
                      <li
                        className={
                          this.props.dashboardActiveLink === "help"
                            ? "active"
                            : ""
                        }
                      >
                      ...
                      {userData && userData.type === "seller" ? (
                        <li>
                          <Link to="/users/store">
                            Store{" "}
                            <span
                              className="tip tip-hot"
                              style={{ background: "#e81279" }}
                            >
                              NEW!
                            </span>
                          </Link>
