...
class Register extends Component {
  ...
  handleInputChange = (event) => {
    ...
    if (name === "country") {
      ...
      if (index !== -1) {
        countryCode = countryData.find((element) => element.country === value)
          .countryCode;
        isoCode = countryData.find((element) => element.country === value)
          .isoCode;
      }
            ...
            <div className="form-popup-content">
              ...
              <form id="register-form" noValidate>
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-sm-12">
                      <div className="form-group">
                        <label htmlFor="firstName" className="rl-label">
                          First Name
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="col-md-6 col-sm-12">
                      <div className="form-group">
                        <label htmlFor="lastName" className="rl-label">
                          Last Name
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="row" style={{ marginBottom: 14 }}>
                    <div className="col-md-6 col-sm-12">
                      <label
                        ...
                        className="rl-label required custom"
                      >
                        Country
                      </label>
                  ...
                  <div className="row">
                    <div className="form-group col-md-6 col-sm-12">
                      <label htmlFor="referredBy" className="rl-label">
                ...
                <div className="terms-condition-container">
                  ...
                  >
                    <span className="checkbox primary primary terms">
                      <span></span>
                    </span>
                    I agree to Azonka’s Terms &amp; Conditions of Use and
                    Privacy Notice
                  </label>
                  {/* <span className="terms">
                                </span> */}
                </div>
                <p style={{ margin: "0px 0px", textAlign: "center" }}>
                  Have an account?
                  <Link
                    style={{ color: "#00d7b3", cursor: "pointer" }}
                    to="/users/login"
                  >
                    {" "}
                    Login
...
const mapStateToProps = (state) => {
  const {
    reg: { loading, error, errorMessage, redirectToVerify },
  } = state;
  return {
    loading,
    error,
...
export default connect(
  mapStateToProps,
  actions
)(withStyles(styles)(withToastManager(Register)));
