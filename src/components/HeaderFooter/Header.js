...
class Header extends Component {
  ...
  handleSelectChange(e, $this) {
    $this.setState({
      ...
      categoryName: window.$("#category option:selected").text().split(" ")[1],
    });
  }
  handleSearchSubmit = async () => {
    ...
    this.props.history.push(
      `/shop?name=${name}&category=${category}&categoryName=${categoryName}`
    );
  };
      ...
      <div>
        <div
          className={`page-wrapper ${
            this.state.mobileMenu ? "mmenu-active" : ""
          }`}
          style={{ position: "fixed", zIndex: "900", width: "100%" }}
        >
          <header
            className="header"
            style={{
              ...
              <div className="container-fluid">
                ...
                <div className="header-right">
                  <p
                    ...
                    style={{ color: "#bce1f4", fontSize: "1.1rem" }}
                  >
                    {currentUser ? (
                  ...
                  <div className="header-dropdown dropdown-expanded">
                    ...
                    <div className="header-menu">
                      <ul>
                        ...
                        {currentUser ? (
                          <li
                            onClick={() => this.handleSideMenuClick("logout")}
                          >
