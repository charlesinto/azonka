  ...
  render() {
    return (
      <>
        <div
          class="modal fade"
          id={`exampleModalCenter${this.props.id}`}
          tabindex="-1"
          role="dialog"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div className="row item-header">
                  <div className="header-item-name col-md-5 ">ITEM</div>
                ...
                {this.props.orderData
                  ? this.props.orderData.map((o) => {
                      ...
                      return (
                        <>
                          <div
                            className="row item-row py-3 my-4 bg-white"
                            key={id}
                          >
                            <div className=" col-md-5 border-right">
                              <div className="d-flex item-name-wrapper">
                                <img
                                  ...
                                  alt=".../"
                                />
                                <p className="pl-4 item-name text-dark">
                                  {" "}
                                  {name}
                                </p>
                              </div>
                                ...
                                <div>
                                  ...
                                  >
                                    ...
                                    <span
                                      ...
                                      data-toggle="modal"
                                      data-target={`#moreReview${randomId}`}
                                ...
                                <div className="d-flex">
                                  <div className="qty-div">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text qty-sub">
                                        -
                                      </span>
                                    </div>
                                    <input
                                    ...
                                    <div class="input-group-append">
                                      <span class="input-group-text qty-add">
                                        +
                                      </span>
                                    </div>
                                  </div>
