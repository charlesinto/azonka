...
class ItemModal extends Component {
  ...
  componentWillReceiveProps = (props) => {
    ...
    if (
      props.itemModalData.itemDetails !==
        this.props.itemModalData.itemDetails &&
      props.itemModalData.itemDetails.length > 0
    ) {
      this.setState({
        modalData: props && props.itemModalData.itemDetails[0],
        products: props.itemModalData.products,
      });
      // console.log(props.itemModalData)
    }
  };
  ...
  handleAddCart = async (e, id) => {
    ...
    if (token) {
      ...
      let obj = products
        ? products.filter((data) => parseInt(id) === data.id)[0]
        : null;
      ...
      if (cartData) {
        ...
        if (isAdded) {
          ...
          return this.props.showSuccessALert(
              ...
              <div className="product-single-container product-single-default product-quick-view container">
                <div className="row">
                  <div className="col-lg-6 col-md-6 product-single-gallery">
                    ...
                    <img
                      src={mainImageUrl}
                      classNameName="responsive-item-image"
                      alt="main item"
                    />
                    <div
                    ...
                    >
                      <div className="col-3 owl-dot">
                        {otherImageUrl1 && otherImageUrl1.trim() !== "" ? (
                          <img
                            src={otherImageUrl1}
                            className="responsive-item-image"
                  ...
                  <div className="col-lg-6 col-md-6">
                    <div className="product-single-details">
                      ...
                      <div className="price-box">
                        <span className="product-price mr-2">
                          ₦{this.formatMoney(finalPrice ? finalPrice / 100 : 0)}
                        </span>
