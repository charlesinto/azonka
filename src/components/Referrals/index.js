                        ...
                        <div className="col-6 ref-div">
                            <div className="card mx-3 py-4 px-4" style={{height: '14rem'}}>
                                <div className="ref-heading">
                                    ...
                                    <div className="ref-icon" ref={this.refCode} onClick={(e) => this.copyToClipBoard(referralCode, 'referralCode')}>
                                        <span><i className="far fa-clipboard"></i></span>
                                    </div>
                                </div>
                                <div className="ref-text py-4">
                                    <textarea id="referralCode" style={{minHeight: '40px !important', height:'40px'}}  className="select-area text-success" readOnly ref={this.referralCode} value={`${referralCode}`}></textarea>
                                </div>
                            </div>
                        </div>
                        <div className="col-6 ref-div ">
                            <div className="card py-4 px-4" style={{height: '14rem'}}>
                                <div className="ref-heading ">
                                    ...
                                    <div className="ref-icon" ref={this.refLink} onClick={(e) => this.copyToClipBoard(`http://167.99.154.149:4000/users/register/${referralCode}`, 'referralLink')}>
                                        <span><i className="far fa-clipboard"></i></span>
                                    </div>
                            ...
                            <div className="ref-text py-4">
                                <div >
                                    ...
                                    <textarea id="referralLink" style={{minHeight: '40px !important', height:'40px'}}  className="select-area text-success" readOnly ref={this.referralCode} value={`http://167.99.154.149:4000/users/register/${referralCode}`}></textarea>
                                </div>
