            ...
            <div className="app-wrapper-container container-fluid">
                <div className="row">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page"><Link to="#">Generate QR Code</Link></li>
                ...
                <div className="row">
                    <div className="col-md-12 col-xs-12">
                        <div className="row d-flex justify-content-center mt-5 mb-2 w-100">
                            ...
                            <div class="qrcode border shadow-sm" id="qr" download>
                                </div>
                        
                        </div>
                        <div className="row d-flex justify-content-center">
                                <button onClick={this.download} className="btn btn-lg btn-secondary">Download</button>
                        </div>
                        <div>
