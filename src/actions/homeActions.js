    ...
    try {
      async.parallel(
        ...
        function (err, results) {
          ...
          return dispatch({
            type: ITEMS_FETCHED_SUCCESSFULLY,
            payload: results,
          });
        }
      );
  ...
  return async (dispatch) => {
    try {
      const response = await axios.get(
        `/api/v1/ad-category/get-ad-categories/0/100`
      );
      console.log("adso: ", response);
      const { adCategories } = response.data;
      console.log("ad cate", adCategories);
  ...
  return async (dispatch) => {
    try {
      const response = await axios.post(
        `/api/v1/seller/delivery/update/${orderId}`,
        {
          deliveryCode,
        },
        {
      ...
      if (error.response && error.response.data.message) {
        ...
        return dispatch({
          type: DISPLAY_ERROR,
          payload: "Could not fulfill request, please try again later",
        });
      }
    }
  };
          ...
          .then((images) => {
            ...
            axios
              ...
              .then((response) => {
                ...
                swal.fire(
                  "Action Successful",
                  "Dispute logged successfully, we will be in touch with you",
                  "success"
                );
              })
              .catch((error) => {
    ...
    try {
      ...
      uploadImages(files)
        .then((images) => {
          ...
          axios
            .put(
              "/api/v1/seller/dispute/reject/" + id,
              {
                message: message,
                simg1: img1,
                simg2: img2,
            ...
            .then((response) => {
              ...
              swal.fire(
                "Action Successful",
                "Operation Successful, we will be in touch with you",
                "success"
              );
            })
            .catch((error) => {
